...
3. EduanimaContents      - コンテンツ管理
4. EduanimaFiles         - ファイルストレージ管理
5. EduanimaSearch        - 検索機能
6. EduanimaAiWorker      - AI処理(OCR・分類)
...
- v7.3.0（2バケット構成、CMEK過小見積もり）: $2.12/月
- v8.8.1（CMEK年次ローテーション、正確な見積もり）: $2.81/月

**コスト分析:**
- **v7.1.0からの削減**: $0.69/月（20%削減）
- **v7.3.0からの増加**: $0.69/月（CMEKコストの現実的な見積もりを反映）
- v7.3.0のCMEKコスト（$0.063/月）は日次ローテーション前提の過小見積もりであり、v8.8.1で年次ローテーション基準の正確な見積もり（$0.75/月）に修正
