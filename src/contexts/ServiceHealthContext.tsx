 ...
 * 
 * Provides centralized service health state to all components
 * - Polls health status every 60 seconds
 * - Syncs CTA disable state within 0-200ms
 * - Shared across HomePage, ProblemViewEditPage, ProblemCreatePage, GeneratingPage, MyPage
 * 
 * @example
 * // In App.tsx
 * <ServiceHealthProvider>
 ...
 * 
 * Hook to access service health state from context
 * Must be used within ServiceHealthProvider
 * 
 * @example
 * const { health, shouldDisableCTA } = useServiceHealthContext();
 * const isDisabled = shouldDisableCTA(['content', 'wallet']);
 */
