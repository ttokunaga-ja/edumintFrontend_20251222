...
import { problemHandlers } from "./problemHandlers"; export const handlers = [ ...healthHandlers, ...searchHandlers, ...notificationsHandlers, ...contentHandlers, ...generationHandlers, ...filesHandlers, ...userHandlers, ...problemHandlers,
];
